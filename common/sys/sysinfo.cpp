...
#elif defined(__MACOSX__) && (defined(__aarch64__) || defined(__ARM_NEON__) || defined(__ARM_NEON))
...
#if defined(__MACOSX__) && (defined(__aarch64__) || defined(__ARM_NEON__) || defined(__ARM_NEON))
